...
import { JsonSchemaFormService, hasOwn, isArray, isDefined, toTitleCase } from 'angular2-json-schema-form';
...
export class IonicFrameworkComponent implements OnInit, OnChanges {
